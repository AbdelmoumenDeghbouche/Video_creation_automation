...
def add_green_screen(arabic_green_screen_text_search, start_time):
    ...
    video_link = "https://www.youtube.com/watch?v=VJ0sntXu-g4"
    ...
    audio_link = "https://www.youtube.com/watch?v=o5jaeEUbpFc"
    ...
    add_sound_to_video(
        ...
        duration=4,  # Play the sound for 10 seconds (optional)
        volume_level=30,  # Set the volume to 30% (optional)
    )


add_green_screen("الوقت", 3)
